...
// 목표) 원하는 영화명(토이스토리)을 검색하면 버튼을 누르면 영화명, 개봉일이 콘솔에 출력
// 데이터 == 변수
...
const laptop_model ='삼성 노트북';
const laptop_size = '15인치';
function laptop_search(){
    console.log(laptop_model);
...
//강릉/20만원/감자빵
const country = '강릉';
let country_price = '20만원';
let country_food = '감자빵';
function country_search () {
    console.log(country);
    console.log(country_price);
